          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative w-full group">
                <select
                  className={`w-full appearance-none border-2 rounded-xl px-4 py-2 text-sm text-[#3b3fb6] bg-white outline-none cursor-pointer transition-all pr-10 ${
                    error && !form.agarBase ? "border-red-500 bg-red-50" : "border-[#3b3fb6] focus:border-[#ffb81c]"
                  }`}
                  value={form.agarBase}
