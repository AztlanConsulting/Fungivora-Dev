...
/**
 * Tarjeta de resumen para el formulario de creación de Medio Líquido.
 *
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <Text variante="label" style={estiloEtiqueta}>
          {varioscodigos ? "Protocolos" : "Protocolo"}
        </Text>
...
export default ResumenMedioLiquido;