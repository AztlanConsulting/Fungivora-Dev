...
export { default as Lotes } from "./lotes/LotesView";
...
export { default as InventarioPrueba } from "./inventario/inventariodummy"export { default as PruebaDb } from "./tests/PruebaDb";